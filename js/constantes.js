...
export const imagenes_staticas = ["https://storage.googleapis.com/gifsbugs/1_genius_335x474.gif",
...
// export const imagenes_estaticas_de_prueba = [
//     "./imagenes_de_prueba/Carnage.jpg",
//     "./imagenes_de_prueba/Batman.jfif",
//     "./imagenes_de_prueba/Ghost Rider.jfif",
//     "./imagenes_de_prueba/Constantine.jfif",
//     "./imagenes_de_prueba/Death.jfif",
//     "./imagenes_de_prueba/Venom.jfif",
// ]
...
export const poemas = [
    [
        ...
        "arroba yahoo punto com punto ar. los ojos",
        ...
        "la repetición  repetición repetición ",
        "de una tarea da por finalizado el procedimiento.",
        " ",
        "es cuando el índice en la mano derecha",
        "responde sin titubeos. presiona ENTER.",
        "la barra carga en su jeringa",
        "un líquido verde: 98% 99% 100% y la página",
        "pasa a otra cosa. dilatada por todo lo anterior,",
        "la memoria no retiene un gramo de información",
    ...
    [
        ...
        "un año tornadizo hasta que agarró viaje.",
        "par de ojos, brazos articulados, dos piernas",
        ...
        "por otro verano negasto? ¿el eco",
    ...
    [
        ">00:00",
        " ",
        ">podríamos afirmar que todo éste mal sueño",
        "empezó la vuelta esa allá en el parque atrás",
        "de la autopista cuando del cielo cayó una gota",
        "opaca que te perforó la mano. fueron tres días",
        "sin curita, de sacarse con cuidado la pelusa",
        "adherida a la ampolla y unos quince más",
        "hasta que la superficie rosácea recuperó",
        "la textura y su color original: un #e3a776",
    ...
    [
        ...
        "de las cosas. fue, dejarla pasar. despertar" ,   //(al siguiente dia(?)
        ...
        "y por dudar, asustarse. obiamente,",
    ...
    [
        ...
        "finita entre el tiempo y espacio, un lugar",
    ...
    [
        ...
        "voz, o porqué no, la pericia empocional",
        "de quen sabe deslizarse a través",
        "de horizontes inestables. pero no, ni vos",
        "ni nadie que presencie ahora el latir amarillo",
        "del mundo. hipo de fotones. intermitencia",
        "que marca el ritmo de la distopía.",
        "humanos cero, nadie que absorba los mensajes",
        "oxidándose en los carteles cascoteados.",
        "indicios de que supo haber movimiento,",
        "direcciones, líneas de existencia programada",
    ...
    [
        ...
        "al mes, cuando las colinas que te encapsulan",
        " ",
        "		          (verdes                     ",
        "	          colinas mentales                ",
    ...
    [
        ...
        "-y no lo hizo- haber abrazado a un amigo",
        "demasiado tenso por el ruido que le causa",
        "su propia respiración; o contemplado la luna llena",
        "por más de diez minutos(ir tras ella, no esperar",
        "a que cruce la ventana, sino ir recto",
        "hacia su desinteresada luminancia). pero ahora",
        "el mundo es otro, uno duro y sin bordes, voraz",
        "como un pitbull reventándose la trompa ",
        "contra el tronco de un árbol, muy distinto",
        "al que uno imaginaba en la suave adolescencia.",
        "bajo esa óptica, de lo que tiene que encargarse es",
        "de no pensar. esa es la misión primera.",
        "inundar el casco con frescos pensamientos blancos,",
        "para después sí, trabar la mandíbula, cerrar",
        "los ojos, concentrarlo todo",
...
// ========================================================================= Programa
// Inicia el proceso de escritura del poema
